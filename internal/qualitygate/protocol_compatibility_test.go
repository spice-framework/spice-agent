...
func TestEngineProtocolCompatibilityManifestFailsClosed(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "released generation proof regression", content: strings.Replace(valid, "\"manifest\": \"compatibility/released-generation.json\",\n    \"proven\": true", "\"manifest\": \"compatibility/released-generation.json\",\n    \"proven\": false", 1)},
		{name: "false binary proof", content: strings.Replace(valid, "\"proven\": false,\n    \"claim\": \"not-claimed\"", "\"proven\": true,\n    \"claim\": \"not-claimed\"", 1)},
...
func TestCompatibilityManifestsFailClosed(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "engine blocker reintroduced", path: compatibilityPolicyPath, old: "\"semantic-client-session-second-conformance-consumer\"", replacement: "\"released-engine-n-minus-one\""},
		{name: "plugin blocker reintroduced", path: compatibilityPolicyPath, old: "\"semantic-client-session-second-conformance-consumer\"", replacement: "\"released-plugin-n-minus-one\""},
		...
		{name: "released generation status drift", path: releasedGenerationCompatibilityPath, old: "\"status\": \"hosted-linux-windows-proven\"", replacement: "\"status\": \"candidate-hosted-evidence-pending\""},
		{name: "released generation workflow drift", path: releasedGenerationCompatibilityPath, old: "actions/workflows/released-compatibility.yml", replacement: "actions/workflows/ci.yml"},
		{name: "released generation run drift", path: releasedGenerationCompatibilityPath, old: "\"run\": 31454312077", replacement: "\"run\": 1"},
		{name: "released generation evidence commit drift", path: releasedGenerationCompatibilityPath, old: "609f74f0abc7e3eba9f8a9ceab3c68ac17208ca2", replacement: strings.Repeat("a", 40)},
		{name: "released generation proof regression", path: releasedGenerationCompatibilityPath, old: "\"proven\": true", replacement: "\"proven\": false"},
		{name: "engine released generation reference regression", path: engineProtocolCompatibilityPath, old: "\"manifest\": \"compatibility/released-generation.json\",\n    \"proven\": true", replacement: "\"manifest\": \"compatibility/released-generation.json\",\n    \"proven\": false"},
		{name: "plugin released generation reference regression", path: pluginProtocolCompatibilityPath, old: "\"manifest\": \"compatibility/released-generation.json\",\n    \"proven\": true", replacement: "\"manifest\": \"compatibility/released-generation.json\",\n    \"proven\": false"},
		{name: "released binary proof invented", path: engineProtocolCompatibilityPath, old: "\"released_binary_matrix\": {\n    \"proven\": false", replacement: "\"released_binary_matrix\": {\n    \"proven\": true"},
		{name: "released binary claim invented", path: pluginProtocolCompatibilityPath, old: "\"claim\": \"not-claimed\"", replacement: "\"claim\": \"released-binaries-proven\""},
