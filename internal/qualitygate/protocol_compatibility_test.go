...
func TestCompatibilityManifestsFailClosed(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "public authoring progress inflated", path: compatibilityPolicyPath, old: "\"proven_extensions\": 2", replacement: "\"proven_extensions\": 3"},
		{name: "generated clean-room progress inflated", path: generatedSourceCompatibilityPath, old: "\"exercised_extensions\": 2", replacement: "\"exercised_extensions\": 3"},
