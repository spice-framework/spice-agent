...
func TestCompatibilityManifestsFailClosed(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "engine blocker reintroduced", path: compatibilityPolicyPath, old: "\"v1_blockers\": []", replacement: "\"v1_blockers\": [\"released-engine-n-minus-one\"]"},
		{name: "plugin blocker reintroduced", path: compatibilityPolicyPath, old: "\"v1_blockers\": []", replacement: "\"v1_blockers\": [\"released-plugin-n-minus-one\"]"},
