...
func TestCompatibilityManifestsFailClosed(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "public authoring progress inflated", path: compatibilityPolicyPath, old: "\"proven_extensions\": 1", replacement: "\"proven_extensions\": 2"},
		{name: "generated clean-room progress inflated", path: generatedSourceCompatibilityPath, old: "\"exercised_extensions\": 1", replacement: "\"exercised_extensions\": 2"},
