...
| Robust decoding | `FuzzPluginEnvelope` exercises initialization and Execute decoding, while `FuzzBootstrap` exercises the bounded fixture stdin parser in the full fuzz smoke gate |
