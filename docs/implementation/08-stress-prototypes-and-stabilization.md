...
- Obtain three separately versioned clean-room compiled extensions using only
  ...
  `spice-agent-tool-json@v0.1.0-preview.1` are complete; one remains.
...
2. frozen generated-source ownership/source-map contracts (released schema 6
   contract and repository migration complete; two of three clean-room
   exercises complete);
...
One more clean-room public-authoring proof and broader optional-extension proofs remain Phase 8 work;
